...
BOOL CListBoxTestDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	m_list.AddString(_T("这是V1IMG"), RGB(0, 0, 0));
	m_list.AddString(_T("这是V2IMG"), RGB(0, 0, 0));
	m_list.AddString(_T("这是V4IMG"), RGB(0, 255, 0));
	m_list.AddString(_T("这是V5IMG"), RGB(0, 0, 255));
	m_list.AddString(_T("这是V6IMG"), RGB(255, 128, 0));
	m_list.SetCurSel(0);
